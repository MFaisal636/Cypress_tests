    ...
    CreateSession() {
        ...
        it('Login', () => {
            ...
            cy.origin('https://comtrak.qa.dmclinical.com/', () => {
                ...
                // cy.wait(15000)
//ul//li/child::a/child::p[text()="Leads "] Leads
//b/parent::p[text()="Leads "]Leads
//img/parent::button[@class="btn btndesk fontopenSans "] Sign in
                /////////////////////////////////////////////////////////////////////////////////////////////
            });
        })
    }

    LoginSession() {  // Define the test case for logg ing in
